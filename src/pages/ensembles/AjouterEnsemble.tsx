...
const AjouterEnsemble = () => {
  ...
  return <Layout>
      ...
      <VetementsPageHeader isAuthenticated={!!user} viewMode="mes-vetements" />
      
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          
          
          {loading ? <div className="flex flex-col items-center justify-center py-16 bg-muted/30 rounded-lg">
              <Loader2 className="h-10 w-10 animate-spin text-primary mb-4" />
              <Text>Chargement de vos vêtements...</Text>
            </div> : vetements.length === 0 ? <Card className="text-center py-12 shadow-md border-primary/10">
            ...
            </Card> : <Card className="shadow-lg border-primary/10 overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex justify-center mt-8 pt-4 border-t">
                  <Button size="lg" className="gap-2 px-6 min-w-40" onClick={handleCreateEnsemble} disabled={creating || !selectedItems.haut || !selectedItems.bas || !selectedItems.chaussures}>
                    {creating ? <>
