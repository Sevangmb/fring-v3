    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          {/* Contenu des onglets (le même pour tous, filtré par l'état React) */}
          ...
          {/* Les autres onglets utilisent le même contenu, filtré par l'état React */}
          {categories.slice(0, 6).map((cat) => (
            <TabsContent key={cat.value} value={cat.value} className="mt-0">
              {/* Le contenu est géré par le filteredVetements */}
            </TabsContent>
          ))}
        </Tabs>
