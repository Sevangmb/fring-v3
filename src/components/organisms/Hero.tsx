  ...
  return <section className={cn("relative overflow-hidden pt-20 md:pt-24 lg:pt-32", className)}>
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <Heading variant="h1" className="mb-6 animate-slide-up">
            Create amazing experiences with our intuitive platform
          </Heading>
          
          <Text variant="lead" className="text-muted-foreground mb-8 animate-slide-up" style={{
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto animate-slide-up" style={{
          ...
          <div className="mt-12 relative w-full max-w-5xl animate-slide-up" style={{
          animationDelay: "300ms"
            ...
            <div className="absolute -z-10 w-16 h-16 bg-primary/5 rounded-full -bottom-8 -left-8 animate-float" style={{
            animationDelay: "1s"
          }}></div>
          </div>
        </div>
